...
import DefectStatusesTable from "./DefectStatusesTable";
...
const DefectStatusesContent = ({ navigation, id, setIs404, state }) => {
	// Init state
	...
	const handleGetData = useCallback(async () => {
		...
		try {
			...
			let result = await API.get(
				`/api/ApplicationDefectStatuses?applicationId=${id}`
			);
	...
	return (
		<div className="container">
			...
			<DeleteDialog
				...
				deleteEndpoint="/api/ApplicationDefectStatuses"
				deleteID={deleteID}
...
export default DefectStatusesContent;
