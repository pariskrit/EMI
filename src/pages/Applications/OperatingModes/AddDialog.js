...
const AddDialog = ({
	...
	const handleAddClick = async () => {
		...
		try {
			...
			setIsUpdating(false);
			closeOverride();
			dispatch(showError("Failed to add operating mode."));
		}
	};
	const handleCreateData = async () => {
		...
		try {
			...
			const result = await API.post("/api/ApplicationOperatingModes", {
			...
			>
				...
				<ADD.ActionContainer>
					<DialogTitle id="alert-dialog-title">
						{<ADD.HeaderText>Add Operating Mode</ADD.HeaderText>}
					</DialogTitle>
					<ADD.ButtonContainer>
						<ADD.CancelButton
