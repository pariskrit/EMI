...
const AddDialog = ({
	...
	const handleAddClick = async () => {
		...
		try {
			...
			setIsUpdating(false);
			closeOverride();
			dispatch(showError("Failed to add feedback priority."));
		}
	};
	const handleCreateData = async () => {
		...
		try {
			...
			const result = await API.post("/api/ApplicationFeedbackPriorities", {
			...
			>
				...
				<ADD.ActionContainer>
					<DialogTitle id="alert-dialog-title">
						{<ADD.HeaderText>Add New Feedback Priority</ADD.HeaderText>}
					</DialogTitle>
					<ADD.ButtonContainer>
						<ADD.CancelButton
