...
const AddSystemDialog = ({
	...
	const handleAddClick = async () => {
		...
		try {
			...
			dispatch(showError("Failed to add system."));
	...
	const handleCreateData = async () => {
		...
		try {
			const result = await API.post("/api/ApplicationSystems", {
			...
			>
				...
				<ADD.ActionContainer>
					<DialogTitle id="alert-dialog-title">
						{<ADD.HeaderText>Add System</ADD.HeaderText>}
					</DialogTitle>
					<ADD.ButtonContainer>
						<ADD.CancelButton
...
export default connect(null, mapDispatchToProps)(AddSystemDialog);
