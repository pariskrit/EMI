...
const EditSystemDialog = ({ open, closeHandler, data, handleEditData }) => {
	// Init state
	...
	const handleUpdateData = async () => {
		...
		try {
			let updateName = await API.patch(`/api/ApplicationSystems/${data.id}`, [
				{
					op: "replace",
					path: "name",
					value: input.name,
	...
	const handleSave = async () => {
		...
		try {
			...
			dispatch(showError("Failed to edit system."));
			...
			>
				...
				<AED.ActionContainer>
					<DialogTitle id="alert-dialog-title">
						{<AED.HeaderText>Edit System</AED.HeaderText>}
					</DialogTitle>
					<AED.ButtonContainer>
						<AED.CancelButton
...
export default EditSystemDialog;
