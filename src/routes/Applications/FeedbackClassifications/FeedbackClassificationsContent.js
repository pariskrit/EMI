...
import FeedbackClassificationsTable from "./FeedbackClassificationsTable";
...
const FeedbackClassificationsContent = ({
	navigation,
	id,
	setIs404,
	state,
	...
	const handleGetData = useCallback(async () => {
		...
		try {
			...
			let result = await API.get(
				`/api/ApplicationFeedbackClassifications?applicationId=${id}`
			);
	...
	const handleDefaultUpdate = async () => {
		...
		try {
			...
			const result = await API.patch(`/api/Applications/${id}`, [
				{
					op: "replace",
					path: "defaultFeedbackClassificationID",
	...
	return (
		<div className="container">
			...
			<DefaultDialog
				...
				data={confirmDefault}
				entity="Feedback Classification"
				handleDefaultUpdate={handleDefaultUpdate}
			/>
			<DeleteDialog
				entityName="Feedback Classification"
				open={openDeleteDialog}
				closeHandler={handleDeleteDialogClose}
				deleteEndpoint="/api/ApplicationFeedbackClassifications"
				deleteID={deleteID}
...
export default FeedbackClassificationsContent;
